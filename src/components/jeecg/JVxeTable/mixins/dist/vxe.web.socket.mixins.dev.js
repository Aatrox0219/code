...
exports.addBindSocketCSD = addBindSocketCSD;
exports.removeBindSocketCSD = removeBindSocketCSD;
...
var vs = {
  ...
  reconnect: function reconnect() {
    ...
    setTimeout(function () {
      ...
      _this2.ws = null; // console.info('【VXEWebSocket】尝试重连...')
...
function addBindSocketCSD(key, fn) {
...
function removeBindSocketCSD(key, fn) {
  if (typeof fn === 'function') {
